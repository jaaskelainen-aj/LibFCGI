...
// -------------------------------------------------------------------------------------------------
bool
SessionBase::refresh(unsigned long max_sec)
{
    time_t now = time(0);
...
// -------------------------------------------------------------------------------------------------
const char*
SessionBase::getCookieSID()
{
    sprintf(g_cookie, "Set-Cookie: sid=%s; SameSite=Strict\r\n", sid);
    return g_cookie;
}
const char*
SessionBase::getCookieLang()
{
    const char* lang = appstr->getLName();
    sprintf(g_cookie,
            "Set-Cookie: lang=%c%c; Expires=Thu, 31-Dec-2019 00:00:00 GMT; SameSite=Strict\r\n",
            lang[0], lang[1]);
    return g_cookie;
}
const char*
...
const char*
SessionBase::dropCookieSID()
{
    strcpy(g_cookie,
           "Set-Cookie: sid=deleted; Max-Age=0; SameSite=Strict\r\n"); // Expires=Thu, 01 Jan 1970
                                                                       // 00:00:00 GMT
    return g_cookie;
}
const char*
SessionBase::dropCookieLang()
{
