...
public:
    ...
    static void close();
    static Framework* get() { if(!the_frame) throw std::runtime_error(fmget_error); return the_frame; }
    ...
    void beginRequest(fcgi_driver::Request *req, std::ostringstream &html, const char *type=0,
                      ostringstream *cookies=0, ostringstream *headers=0);
    ...
    static void decodeURL(const char *URL, string &target);
