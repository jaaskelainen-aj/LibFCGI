...
// -------------------------------------------------------------------------------------------------
void PostData::set(const char *data)
{
    STATE state = KEY;
    PACK64 pack;
    int ch_ndx;
...
// -------------------------------------------------------------------------------------------------
const char *PostData::get(const char *key)
{
    size_t ndx;
    PACK64 pack;
    if(!count)
...
// -------------------------------------------------------------------------------------------------
const char *PostData::get(int ndx)
{
...
// -------------------------------------------------------------------------------------------------
void PostData::add(const char *key, const char *value)
{
    size_t ndx;
    PACK64 pack;
